...
public class BorgunAuthorisationEntryDAO extends GenericDaoImpl implements AuthorisationEntriesDAO<BorgunAuthorisationEntry> {
	...
	public CreditCardAuthorizationEntry findByReference(String reference) {
		...
		try {
			return getSingleResult(BorgunAuthorisationEntry.GET_BY_REFRENCE, BorgunAuthorisationEntry.class, new Param(CreditCardAuthorizationEntry.COLUMN_REFERENCE, reference));
 		} catch (Exception e) {
