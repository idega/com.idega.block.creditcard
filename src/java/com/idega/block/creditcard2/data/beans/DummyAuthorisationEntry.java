...
@NamedQueries(
		{
			@NamedQuery(
					name = DummyAuthorisationEntry.GET_BY_ID,
					query = "from DummyAuthorisationEntry bae where bae."+DummyAuthorisationEntry.idProp+" = :"+DummyAuthorisationEntry.idProp
					),
			@NamedQuery(
					name = DummyAuthorisationEntry.GET_BY_PARENT_ID,
					query = "from DummyAuthorisationEntry bae where bae."+DummyAuthorisationEntry.parentProp+" = :"+DummyAuthorisationEntry.parentProp
					),
			@NamedQuery(
					name = DummyAuthorisationEntry.GET_BY_AUTH_CODE,
					query = "from DummyAuthorisationEntry bae where bae."+DummyAuthorisationEntry.authCodeProp+" = :"+DummyAuthorisationEntry.authCodeProp
					),
			@NamedQuery(
					name = DummyAuthorisationEntry.GET_BY_DATES,
					query = "from DummyAuthorisationEntry bae where bae."+DummyAuthorisationEntry.dateProp+" >= :"+DummyAuthorisationEntry.dateFromProp + " and " +DummyAuthorisationEntry.dateProp+ " <=:" +DummyAuthorisationEntry.dateToProp 
					),
			@NamedQuery(
					name = DummyAuthorisationEntry.GET_REFUNDS_BY_DATES,
					query = "from DummyAuthorisationEntry bae where bae.transactionType = 1 and bae."+DummyAuthorisationEntry.dateProp+" >= :"+DummyAuthorisationEntry.dateFromProp + " and " +DummyAuthorisationEntry.dateProp+ " <=:" +DummyAuthorisationEntry.dateToProp 
					)
		}
	)
