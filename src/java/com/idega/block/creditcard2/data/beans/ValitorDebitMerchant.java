...
@Entity
@Table(name = "VALITORDEBIT_MERCHANT")
@NamedQueries({
		@NamedQuery(name = ValitorDebitMerchant.GET_BY_ID, query = "from ValitorDebitMerchant bm where bm." + ValitorDebitMerchant.idProp
				+ " = :" + ValitorDebitMerchant.idProp),
		@NamedQuery(name = ValitorDebitMerchant.GET_BY_NAME, query = "from ValitorDebitMerchant bm where bm."
				+ ValitorDebitMerchant.nameProp + " = :" + ValitorDebitMerchant.nameProp) })
public class ValitorDebitMerchant implements CreditCardMerchant {

	public static final String GET_BY_ID = "ValitorDebitMerchant.getByID";
	public static final String GET_BY_NAME = "ValitorDebitMerchant.getByName";
