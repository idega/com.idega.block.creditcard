...
@NamedQueries(
		{
			@NamedQuery(
					name = KortathjonustanAuthorisationEntry.GET_BY_ID,
					query = "from KortathjonustanAuthorisationEntry bae where bae."+KortathjonustanAuthorisationEntry.idProp+" = :"+KortathjonustanAuthorisationEntry.idProp
					),
			@NamedQuery(
					name = KortathjonustanAuthorisationEntry.GET_BY_PARENT_ID,
					query = "from KortathjonustanAuthorisationEntry bae where bae."+KortathjonustanAuthorisationEntry.parentProp+" = :"+KortathjonustanAuthorisationEntry.parentProp
					),
			@NamedQuery(
					name = KortathjonustanAuthorisationEntry.GET_BY_AUTH_CODE,
					query = "from KortathjonustanAuthorisationEntry bae where bae."+KortathjonustanAuthorisationEntry.authCodeProp+" = :"+KortathjonustanAuthorisationEntry.authCodeProp
					),
			@NamedQuery(
					name = KortathjonustanAuthorisationEntry.GET_BY_DATES,
					query = "from KortathjonustanAuthorisationEntry bae where bae."+KortathjonustanAuthorisationEntry.dateProp+" >= :"+KortathjonustanAuthorisationEntry.dateFromProp + " and " +KortathjonustanAuthorisationEntry.dateProp+ " <=:" +KortathjonustanAuthorisationEntry.dateToProp 
					),
			@NamedQuery(
					name = KortathjonustanAuthorisationEntry.GET_REFUNDS_BY_DATES,
					query = "from KortathjonustanAuthorisationEntry bae where bae.transactionType = "+KortathjonustanAuthorisationEntry.AUTHORIZATION_TYPE_REFUND+" and bae."+KortathjonustanAuthorisationEntry.dateProp+" >= :"+KortathjonustanAuthorisationEntry.dateFromProp + " and " +KortathjonustanAuthorisationEntry.dateProp+ " <=:" +KortathjonustanAuthorisationEntry.dateToProp 
					)
		}
	)
public class KortathjonustanAuthorisationEntry implements CreditCardAuthorizationEntry{
	...
	public KortathjonustanAuthorisationEntry getParent() {
		return parent;
	}
