 ...
 *         &lt;element name="KortnumerObrenglad" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 ...
 *         &lt;element name="Tilvisunarnumer" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
public class Kvittun {
    ...
    @XmlElement(name = "KortnumerObrenglad")
    protected String kortnumerObrenglad;
    @XmlElement(name = "Upphaed")
    protected String upphaed;
    @XmlElement(name = "Gjaldmidill")
    protected String gjaldmidill;
    @XmlElement(name = "Tilvisunarnumer")
    protected String tilvisunarnumer;
